...
public class GalleryActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tabhost_gallery);
		gallery = (Gallery) findViewById(R.id.tabhost_grllery_gallery);
		imageAdapter = new ImageAdapter(this);
		gallery.setAdapter(imageAdapter);
		gallery.setOnItemSelectedListener(this);
		imageSwitcher = (ImageSwitcher) findViewById(R.id.tabhost_gallery_imageswitcher);
