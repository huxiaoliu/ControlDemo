...
public class RatingListViewActivity extends ListActivity {
	private static String[] applicationNames = new String[] { "多功能日历",
			"eoeMarket客户端", "耐玩的重力消砖块", "白社会", "程序终结者" };
	private static String[] authors = new String[] { "李宁", "eoemobile", "wawa",
			"ApkHome", "lucyfa" };
	private static int[] resIds = new int[] { R.drawable.calendar,
			R.drawable.eoemarket, R.drawable.brick, R.drawable.whitesociety,
			R.drawable.terminater };
	private static float[] applicationRating = new float[] { (float) 5.0,
			(float) 5.0, (float) 3.5, (float) 5.0, (float) 4.0 };
	...
	private class RatingAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			LinearLayout linearLayout = (LinearLayout) layoutInflater.inflate(
					R.layout.tabhost_rating_main, null);
			ImageView ivLogo = (ImageView) linearLayout
					.findViewById(R.id.tabhost_ratingmain_ivLogo);
	...
	protected void onListItemClick(ListView l, View v, final int position, long id) {
		...
		View myView = getLayoutInflater().inflate(R.layout.tabhost_rating, null);
		final RatingBar ratingBar = (RatingBar) myView
				.findViewById(R.id.tabhost_rating_ratingbar);
		ratingBar.setRating(applicationRating[position]);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewList.add(getLayoutInflater().inflate(R.layout.tabhost_rating_main,
				null));
